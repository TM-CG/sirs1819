...
public class RequestTime {
	...
	public RequestTimeView requestTimeBuild(Date timeRequest) {
		...
		requestTimeView.setTimeRequest(XMLHelper.dateToXML(timeRequest));
	...
	public Date getTimeRequest() {
		Date time = XMLHelper.xmlToDate(view.getTimeRequest());
		return time;
	}

	public void setTimeRequest(Date timeRequest) {
		XMLGregorianCalendar xgc = XMLHelper.dateToXML(timeRequest);
	...
	public Node toXMLNode(String requestTimeTagName) throws JAXBException {
		return XMLHelper.viewToXML(RequestTimeView.class, view, new QName(requestTimeTagName));
	}

	/** Marshal requestTime to XML bytes. */
	public byte[] toXMLBytes(String requestTimeTagName) throws JAXBException {
		return XMLHelper.viewToXMLBytes(RequestTimeView.class, view, new QName(requestTimeTagName));
	}
	...
	public void fromXMLNode(Node xml) throws JAXBException {
		RequestTimeView view= XMLHelper.xmlNodeToView(RequestTimeView.class, xml);
	...
	public void fromXMLBytes(byte[] bytes) throws JAXBException {
		RequestTimeView view = XMLHelper.xmlBytesToView(RequestTimeView.class, bytes);
		// set view should not allow null
		setView(view);
	}
