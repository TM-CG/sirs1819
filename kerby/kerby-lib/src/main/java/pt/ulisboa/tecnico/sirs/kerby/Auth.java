...
public class Auth {
	...
	public AuthView authBuild(String x, Date timeRequest) {
		...
		auth.setTimeRequest(XMLHelper.dateToXML(timeRequest));
		auth.setX(x);
		return auth;
	}
	...
	public Node toXMLNode(String authTagName) throws JAXBException {
		return XMLHelper.viewToXML(AuthView.class, view, new QName(authTagName));
	}

	/** Marshal auth to XML bytes. */
	public byte[] toXMLBytes(String authTagName) throws JAXBException {
		return XMLHelper.viewToXMLBytes(AuthView.class, view, new QName(authTagName));
	}
	...
	public void fromXMLNode(Node xml) throws JAXBException {
		AuthView view= XMLHelper.xmlNodeToView(AuthView.class, xml);
	...
	public void fromXMLBytes(byte[] bytes) throws JAXBException {
		AuthView view = XMLHelper.xmlBytesToView(AuthView.class, bytes);
		// set view should not allow null
		setView(view);
	}
