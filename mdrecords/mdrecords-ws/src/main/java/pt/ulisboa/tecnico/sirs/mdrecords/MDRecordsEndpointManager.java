...
public class MDRecordsEndpointManager {
    ...
    private MDRecordsPortImpl portImpl = new MDRecordsPortImpl(this);

    public MDRecordsPortImpl getPort() {
		return portImpl;
    }
	...
	public MDRecordsEndpointManager(String uddiURL, String wsName, String wsURL) {
